...
const firebaseConfig = {
    apiKey: "AIzaSyCE3UjewnsxckIpD7MoJ_Gg8KHtrul-GNg",
    authDomain: "mixadvertpush.firebaseapp.com",
    databaseURL: "https://mixadvertpush.firebaseio.com",
    projectId: "mixadvertpush",
    storageBucket: "mixadvertpush.appspot.com",
    messagingSenderId: "399837804389",
    appId: "1:399837804389:web:8615892fbe0d847ab5938c"
};
...
function sendTokenToServer(currentToken) {
    ...
    try {
        ...
        let oldToken = window.localStorage.getItem('sentFirebaseMessagingToken');

        if(oldToken !== null && oldToken !== currentToken){
            fd.append('token_refreshed', oldToken);
        }
